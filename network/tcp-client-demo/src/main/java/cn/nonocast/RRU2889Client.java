  ...
  private void setupTimer() {
    ...
    this.timer.newTimeout(new TimerTask() {
      ...
      public void run(Timeout timeout) throws Exception {
        RRU2889Client.this.send(new byte[] { (byte) 0x04, (byte) 0xff, (byte) 0x21, (byte) 0x19, (byte) 0x95 });
        RRU2889Client.this.timer.newTimeout(this, 2, TimeUnit.SECONDS);
      }
    }, 2, TimeUnit.SECONDS);
  }
